angular.module('fbApp')
    .controller('eventsCtrl', ['$scope', 'initView', '$timeout', 'db', '$state', 'langService', '$rootScope', 'City', 'Events', 'Favorites',
        function($scope, initView, $timeout, db, $state, langService, $rootScope, City, Events, Favorites) {
            ...
            $scope.selection = Events.list($scope.city);
                ...
                function sortData() {
                    $timeout(function(){
                        ...
                        $scope.filtered.sort(function(a, b) {
                            ...
                            } else if (critera == 'byDate') {
                                return - parseFloat(a.dt_start) + parseFloat(b.dt_start);
                            }
                            return 0;
                        });
                    },0);
