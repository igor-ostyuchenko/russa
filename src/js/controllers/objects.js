angular.module('fbApp')
    .controller('objectsCtrl', ['$scope', 'initView', '$timeout', 'db', '$state', 'langService', '$rootScope', 'City', 'Objects', 'Navigator', 'Favorites',
        function($scope, initView, $timeout, db, $state, langService, $rootScope, City, Objects, Navigator, Favorites) {
            ...
            $scope.selection = Objects.list($scope.city);
            ...
            $scope.setActive = function(item) {
                ...
                $timeout(function() {
                    Objects.setCurrent(item);
                    $state.go('object', {object: item});
                }, 500);
            };

            $scope.checkFavorite = function(item) {
                return Favorites.check(item, 'object');
            };
